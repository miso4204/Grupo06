		...
		fill: function () {
			...
			for (var i = 0; i < 24; i++) {
				...
				if (this.showMeridian && dates[this.language].meridiem.length == 2) {
					...
					txt = i + ':00';
					html.push('<span class="hour' + clsName + '">' + txt + '</span>'+'<br>');
				}
			}
			...
			for (var i = 0; i < 60; i += this.minuteStep) {
				...
				if (this.showMeridian && dates[this.language].meridiem.length == 2) {
					...
					html.push('<span class="minute' + clsName + '">' + txt + ':' + (i < 10 ? '0' + i : i) + '</span>'+'<br>');
					if (i == 59) {
						html.push('</fieldset>');
					}
				} else {
					...
					html.push('<span class="minute' + clsName + '">' + hours + ':' + (i < 10 ? '0' + i : i) + '</span>'+'<br>');
				}
			}
