...
public class PagoTarjetaCreditoFragment  extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_pago_tarjeta_credito,container, false);
		cargarDatosLocales();
	...
	private void cargarElementosGraficos() {
		buttonPagar = (Button) view.findViewById(R.id.Pago_Tarjeta_Credito_Button);
	...
	private void cargarListeners() {
		buttonPagar.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				new PagarAsyncTask((PagosActivity)getActivity()).execute(userName,TiposPago.CREDIT_CARD);
			}
		});
