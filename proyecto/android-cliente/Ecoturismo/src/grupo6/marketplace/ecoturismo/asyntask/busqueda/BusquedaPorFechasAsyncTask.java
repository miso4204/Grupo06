...
public class BusquedaPorFechasAsyncTask extends AsyncTask<String, Void, List<Producto>> {
	
	protected static final String TAG = "BusquedaPorFechasAsyncTask";
	private int respuesta;
	private ProgressDialog progressDialog;
	private String fechaInicial;
	private String fechaFinal;
	private AndroidHttpClient androidHttpCliente = AndroidHttpClient.newInstance("");
	private ProductosPorFechaFragment productosFragment;
	
	public BusquedaPorFechasAsyncTask(ProductosPorFechaFragment productosFragment) {
	...
	protected List<Producto> doInBackground(String... params) {
		try{
			...
			String urlFinal = Busqueda.URL_BUSQUEDA
						      .replace(Busqueda.FECHA_INICIAL, ""+fechaInicial)
							  .replace(Busqueda.FECHA_FINAL, ""+fechaFinal);
	...
	private static class Busqueda {
		...
		public static final String URL_BUSQUEDA = Constantes.URL_BASE + "services/producto/buscar_por_fecha/"+FECHA_INICIAL+"/"+FECHA_FINAL;
