...
/**
 * Controlador web que procesa servicios REST para el módulo de ofertas.
 * @author caespinosam
 *
 */
...
public class OfertasRestController {
	 ...
	 * El servicio está mapeado a la URL services/ofertas/crear de tipo POST.
	 * La peticion POST debe enviar como parámetro un string JSON
	 * con los datos de la oferta a crear.
	 * @param oferta la objeto cerado a partir del JSON de la petición.
