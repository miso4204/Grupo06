...
/**
 * Controlador web que procesa servicios REST para el módulo de búsquedas.
 * @author caespinosam
 *
 */
...
public class BusquedasRestController {
	 ...
	 * El servicio está mapeado a la URL /services/busquedas/listas_todas de tipo GET.
	 * 
	 ...
	 * El servicio está mapeado a la URL /services/busquedas/buscar_por_ciudad/{string} de tipo GET.
	 * 
